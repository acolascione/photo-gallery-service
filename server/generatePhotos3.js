...
const outer = async () => {
  ...
  await createPhoto();
  const res = await connection.query("COPY photo (user_id, description, date, restaurant_id, category, url)  FROM '/Users/alissacolascione/hrsf130/photo-gallery-service/server/photo_data3.csv' DELIMITERS ',' CSV header;");
